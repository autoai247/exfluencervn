    ...
    <div className="min-h-screen bg-dark-700 pb-20">
      ...
      <div className="container-mobile space-y-6 py-6">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 via-blue-500 to-red-500 p-[3px]">
          <div className="bg-dark-700/90 backdrop-blur-sm rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-red-500 to-blue-500 rounded-full mt-3 shadow-lg shadow-red-500/30">
        ...
        {/* Progress Section */}
        <div className="bg-dark-600/80 backdrop-blur-sm border border-primary/30 rounded-2xl p-4 shadow-xl bg-gradient-to-br from-primary/10 to-secondary/10">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <div className="w-1 h-4 bg-gradient-to-b from-primary to-secondary rounded-full" />
              <h3 className="text-sm font-semibold text-white">{t.koreaDream.realtimeProgress}</h3>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3 pt-3 border-t border-dark-500/50">
        ...
        {/* My Tickets */}
        <div className="bg-dark-600/80 backdrop-blur-sm border border-accent/30 rounded-2xl p-4 shadow-xl bg-gradient-to-br from-accent/20 to-accent/5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-accent to-accent/70 rounded-xl flex items-center justify-center shadow-lg shadow-accent/20">
          ...
          {eventData.myTickets > 0 ? (
            ...
            <div className="text-center py-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-semibold shadow-lg shadow-primary/20 px-4 py-2 text-sm"
              >
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 px-1">
            <div className="w-1 h-4 bg-gradient-to-b from-primary to-secondary rounded-full" />
            <h3 className="text-sm font-semibold text-white">{t.koreaDream.prizeComposition}</h3>
          </div>
          <div className="space-y-3">
            {prizeDetailsStructure.map((prize, index) => {
              const Icon = prize.icon;
              return (
                <div key={index} className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl hover:border-primary/30 transition-colors">
          ...
          <div className="bg-dark-600/80 backdrop-blur-sm border border-success/30 rounded-2xl p-4 shadow-xl bg-gradient-to-r from-success/10 to-success/5">
            <div className="flex items-center gap-2">
        ...
        {/* Exchange Section */}
        <div id="exchange" className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center gap-2">
              <div className="w-1 h-4 bg-gradient-to-b from-primary to-secondary rounded-full" />
              <h3 className="text-sm font-semibold text-white">{t.koreaDream.ticketExchange}</h3>
            </div>
          ...
          <div className="bg-dark-600/80 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-4 shadow-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10">
          ...
          <div className="space-y-3">
            {exchangePackages.map((pkg, index) => (
              <div
                ...
                className={`bg-dark-600/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl cursor-pointer transition-all ${
                  shoppingPoints >= pkg.points
                    ? 'border border-primary/30 hover:border-primary/60 hover:shadow-primary/10'
                    : 'border border-dark-400/40 opacity-50 cursor-not-allowed'
                }`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {pkg.discount > 0 && (
                        <span className="px-2 py-0.5 bg-gradient-to-r from-accent to-accent/70 text-white text-xs rounded-full font-bold shadow-sm">
                          -{pkg.discount}%
                        </span>
                      )}
                    </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 px-1">
            <div className="w-1 h-4 bg-gradient-to-b from-primary to-secondary rounded-full" />
            <h3 className="text-sm font-semibold text-white">{t.koreaDream.rankingTop5}</h3>
          </div>
          <div className="space-y-3">
            {topRankers.map((ranker) => (
              <div
                key={ranker.rank}
                className={`bg-dark-600/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border ${
                  ranker.rank === 1 ? 'border-yellow-500/40' :
                  ranker.rank === 2 ? 'border-gray-400/40' :
                  ranker.rank === 3 ? 'border-orange-500/40' :
                  'border-dark-400/40'
                }`}
              >
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                    ranker.rank === 1 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600 shadow-lg shadow-yellow-500/30' :
                    ranker.rank === 2 ? 'bg-gradient-to-br from-gray-300 to-gray-500 shadow-lg shadow-gray-400/20' :
                    ranker.rank === 3 ? 'bg-gradient-to-br from-orange-400 to-orange-700 shadow-lg shadow-orange-500/20' :
                    'bg-dark-500'
                  }`}>
                    {ranker.rank === 1 ? (
                      ...
                      <span className="text-gray-400">{ranker.rank}</span>
                    )}
                  </div>
                  <div className="flex-1">
                    <div className={`font-semibold ${
                      ranker.rank === 1 ? 'text-yellow-400' :
                      ranker.rank === 2 ? 'text-gray-300' :
                      ranker.rank === 3 ? 'text-orange-400' :
                      'text-white'
                    }`}>{ranker.name}</div>
          ...
          <Link href="/main/influencer/korea-dream/ranking">
            <div className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl text-center text-sm font-semibold text-gray-300 hover:text-white hover:border-primary/30 transition-all">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 px-1">
            <div className="w-1 h-4 bg-gradient-to-b from-primary to-secondary rounded-full" />
            <h3 className="text-sm font-semibold text-white">{t.koreaDream.howToEarnPoints}</h3>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <Link href="/main/influencer/attendance" className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl hover:border-success/30 transition-colors text-center py-4">
              <div className="w-12 h-12 bg-gradient-to-br from-success/30 to-success/10 rounded-xl flex items-center justify-center mx-auto mb-2">
            ...
            <Link href="/main/influencer/referral" className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl hover:border-primary/30 transition-colors text-center py-4">
              <div className="w-12 h-12 bg-gradient-to-br from-primary/30 to-primary/10 rounded-xl flex items-center justify-center mx-auto mb-2">
            ...
            <Link href="/main/influencer/campaigns" className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl hover:border-warning/30 transition-colors text-center py-4">
              <div className="w-12 h-12 bg-gradient-to-br from-warning/30 to-warning/10 rounded-xl flex items-center justify-center mx-auto mb-2">
            ...
            <Link href="/main/influencer/profile" className="bg-dark-600/80 backdrop-blur-sm border border-dark-400/40 rounded-2xl p-4 shadow-xl hover:border-accent/30 transition-colors text-center py-4">
              <div className="w-12 h-12 bg-gradient-to-br from-accent/30 to-accent/10 rounded-xl flex items-center justify-center mx-auto mb-2">
        ...
        {/* CTA */}
        <div className="bg-dark-600/80 backdrop-blur-sm border border-red-500/30 rounded-2xl p-4 shadow-xl bg-gradient-to-r from-red-500/10 via-blue-500/10 to-purple-500/10">
          <div className="text-center">
      ...
      {showExchangeModal && selectedPackage !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-dark-600/90 backdrop-blur-sm rounded-2xl p-6 w-full max-w-md border border-primary/30 shadow-2xl">
