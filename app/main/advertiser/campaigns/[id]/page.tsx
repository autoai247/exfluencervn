...
export default function CampaignDetailPage() {
  ...
  const handleApprove = (applicant: any) => {
    ...
    alert(`Đã chấp thuận ${applicant.name}!`);
  };

  // Handle reject applicant
  const handleReject = (applicant: any) => {
    const reason = prompt(`Nhập lý do từ chối ứng viên ${applicant.name} (tùy chọn):`);

    // Remove from pending
    setPendingApplicants(prev => prev.filter(a => a.id !== applicant.id));

    alert(`Đã từ chối ứng viên ${applicant.name}.${reason ? `\nLý do: ${reason}` : ''}`);
  };
  ...
  const calculateApplicantMatch = (applicant: any) => {
    ...
    criteria.push({ name: 'Danh mục', match: categoryMatch, weight: 15 });
    ...
    criteria.push({ name: 'Giới tính', match: genderMatch, weight: 10 });
    ...
    criteria.push({ name: 'Loại da', match: skinTypeMatch, weight: 10 });
    ...
    criteria.push({ name: 'Tông da', match: skinToneMatch, weight: 5 });
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-4">
        ...
        <Breadcrumb
          items={[
            { label: 'Chiến dịch', href: '/main/advertiser/campaigns' },
      ...
      <div className="container-mobile space-y-6 py-6">
        ...
        {/* Budget Progress */}
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <h3 className="text-sm font-semibold text-gray-900 mb-3">Tình trạng sử dụng ngân sách</h3>
          <div className="mb-3">
            <div className="flex justify-between text-sm mb-2">
              <span className="text-gray-600">Ngân sách đã dùng</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="text-xs text-gray-500 mt-1">KOL được chấp thuận</div>
          ...
          >
            ...
            <div className="text-xs text-gray-500 mt-1">Tổng ứng viên</div>
            <div className="text-xs text-gray-400 mt-1">👆 Nhấn để xem</div>
          </div>
          ...
          >
            ...
            <div className="text-xs text-gray-500 mt-1">Mỗi KOL</div>
            <div className="text-xs text-gray-400 mt-1">👆 Nhấn để xem</div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
          <h3 className="text-sm font-semibold text-gray-900 mb-3">Thông tin chiến dịch</h3>
        ...
        {/* Requirements */}
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <h3 className="text-sm font-semibold text-gray-900 mb-3">Yêu cầu ứng tuyển</h3>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-600">Người theo dõi tối thiểu:</span>
              <span className="text-gray-900">{mockCampaignDetail.requirements.minFollowers.toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Tỷ lệ tương tác tối thiểu:</span>
        ...
        {/* Deliverables */}
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <h3 className="text-sm font-semibold text-gray-900 mb-3">Yêu cầu nội dung</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-900">KOL được chấp thuận ({acceptedInfluencers.length})</h3>
            ...
            <div key={influencer.id} className="bg-white border border-gray-200 rounded-xl p-4">
              <div className="flex items-start gap-3 mb-3">
                ...
                <span className={`px-3 py-1 rounded-full text-xs ${
                  ...
                  {influencer.status === 'completed' ? 'Hoàn thành' : 'Đang thực hiện'}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="bg-gray-50 rounded-lg p-2">
                  <p className="text-gray-600">Tỷ lệ tương tác</p>
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 space-y-3">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              alert('Đã đánh dấu thanh toán hoàn thành (demo)');
                            }
                          }}
                        />
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        💡 Khi KOL xác nhận "Đã nhận", quy trình sẽ tiến sang bước tiếp theo
                      </p>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Đơn vị vận chuyển</label>
                        ...
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Mã vận đơn</label>
                          <input
                            type="text"
                        ...
                        <button
                          onClick={() => alert('Đã lưu thông tin gửi hàng (demo)')}
                          className="w-full bg-gray-900 text-white hover:bg-gray-800 rounded-lg text-xs py-2"
                        >
                          Xác nhận gửi hàng
                        </button>
                        <p className="text-xs text-gray-500">
                          💡 Khi nhập mã vận đơn, KOL có thể theo dõi đơn hàng
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {mockCampaignDetail.deliveryType === 'service' && (
                    <div>
                      <h5 className="text-xs font-semibold text-gray-900 mb-2 flex items-center gap-2">
                        ...
                        Thông tin ghé thăm cửa hàng
                      </h5>
                      <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Địa chỉ cửa hàng</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Giờ mở cửa</label>
                          <input
                            type="text"
                            placeholder="T2-T6 10:00-20:00, Cuối tuần 10:00-22:00"
                            className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-900 placeholder-gray-400 focus:border-gray-900 focus:outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Liên hệ phụ trách</label>
                          <input
                            type="text"
                        ...
                        <button
                          onClick={() => alert('Đã lưu thông tin cửa hàng (demo)')}
                          className="w-full bg-gray-900 text-white hover:bg-gray-800 rounded-lg text-xs py-2"
                        >
                          Lưu thông tin
                        </button>
                        <p className="text-xs text-gray-500">
                          💡 KOL sẽ ghé thăm cửa hàng để trải nghiệm dịch vụ/sản phẩm
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {mockCampaignDetail.deliveryType === 'visit' && (
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Ngày gặp</label>
                          <input
                            type="date"
                        ...
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Giờ gặp</label>
                          <input
                            type="time"
                            className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-900 focus:border-gray-900 focus:outline-none"
                          />
                        ...
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Địa điểm gặp</label>
                          <input
                            type="text"
                            placeholder="Văn phòng, địa điểm sự kiện, v.v."
                            className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-900 placeholder-gray-400 focus:border-gray-900 focus:outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-xs text-gray-600">Ghi chú đặc biệt</label>
                          <textarea
                            placeholder="Thông tin đỗ xe, vật dụng cần chuẩn bị, v.v."
                            rows={2}
                        ...
                        <button
                          onClick={() => alert('Đã lưu lịch gặp (demo)')}
                          className="w-full bg-gray-900 text-white hover:bg-gray-800 rounded-lg text-xs py-2"
                        >
                          Xác nhận lịch
                        </button>
                        <p className="text-xs text-gray-500">
                          💡 Hẹn gặp trực tiếp với KOL để bàn giao sản phẩm/dịch vụ
                        </p>
                      </div>
                    </div>
                  )}
              ...
              {influencer.status === 'completed' && (
                <div className="mt-3 pt-3 border-t border-gray-200">
                  <div className="grid grid-cols-2 gap-2 text-xs mb-3">
                    ...
                    <div>
                      <p className="text-gray-600">Lượt thích</p>
              ...
              {influencer.submittedContent && influencer.submittedContent.length > 0 && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <h4 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                    <Eye size={16} />
                    Nội dung đã nộp ({influencer.submittedContent.length})
                  </h4>
                  <div className="space-y-3">
                      ...
                      <div key={content.id} className="bg-gray-50 rounded-lg p-3">
                        ...
                        {content.status === 'pending' ? (
                          <div className="flex gap-2 mt-2">
                            <button
                              onClick={() => alert('Đã chấp thuận nội dung (demo)')}
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (reason) alert(`Đã từ chối: ${reason} (demo)`);
                              }}
                          ...
                          <div className="mt-2 flex items-center gap-2 text-xs">
                            ...
                            <span className="text-green-700">Đã duyệt</span>
        ...
        {/* Pending Applicants */}
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-900">Ứng viên đang chờ ({pendingApplicants.length})</h3>
              ...
              <div key={applicant.id} className={`relative bg-white rounded-xl p-4 ${
                ...
                <div className="absolute top-3 right-3">
                  <div className={`px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1 ${
                    ...
                    <CheckCircle size={12} />
                    Phù hợp {matchResult.percentage}%
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                      ...
                      {applicant.gender && <span>• {applicant.gender === '여성' ? 'Nữ' : applicant.gender === '남성' ? 'Nam' : applicant.gender}</span>}
                      {applicant.age && <span>• {applicant.age} tuổi</span>}
                    </div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">Ngày ứng tuyển: {applicant.appliedAt}</p>
                  </div>
              </div>
                ...
                <div className="mt-2 pt-2 border-t border-gray-200 space-y-1">
                  {matchResult.criteria.map((criterion, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-gray-500">{criterion.weight} điểm</span>
                        {criterion.match ? (
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowAcceptedModal(false)}>
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 flex items-center justify-between p-6 pb-4 bg-white border-b border-gray-200 rounded-t-2xl">
              <h3 className="text-lg font-bold text-gray-900">KOL được chấp thuận ({acceptedInfluencers.length})</h3>
              ...
              {acceptedInfluencers.map((influencer) => (
                <div key={influencer.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">{influencer.engagement}% tương tác</p>
                  </div>
                  <button
                    onClick={() => {
      ...
      {showApplicantsModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowApplicantsModal(false)}>
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 flex items-center justify-between p-6 pb-4 bg-white border-b border-gray-200 rounded-t-2xl">
              <h3 className="text-lg font-bold text-gray-900">Tất cả ứng viên ({acceptedInfluencers.length + pendingApplicants.length})</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 pt-4">
              {/* 승인된 인플루언서 */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-gray-900 mb-3">Đã chấp thuận ({acceptedInfluencers.length})</h4>
                <div className="space-y-2">
                  {acceptedInfluencers.map((influencer) => (
                    <div key={influencer.id} className="flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <span className="px-2 py-1 bg-green-600 text-white text-xs rounded-full">Chấp thuận</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* 대기 중인 지원자 */}
              <div>
                <h4 className="text-sm font-semibold text-gray-900 mb-3">Đang chờ ({pendingApplicants.length})</h4>
                <div className="space-y-2">
                  {pendingApplicants.map((applicant) => (
                    <div key={applicant.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="px-2 py-1 bg-yellow-100 text-yellow-700 text-xs rounded-full">Đang chờ</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {showBudgetModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowBudgetModal(false)}>
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 flex items-center justify-between p-6 pb-4 bg-white border-b border-gray-200 rounded-t-2xl">
              <h3 className="text-lg font-bold text-gray-900">Chi tiết phân bổ ngân sách</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 pt-4">
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-600">Mục tiêu số KOL</span>
                    <span className="text-sm font-bold text-gray-900">{mockCampaignDetail.targetInfluencers} KOL</span>
                  </div>
                  <div className="flex justify-between mb-2 pb-2 border-b border-gray-200">
                    <span className="text-sm text-gray-600">Ngân sách mỗi KOL</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Ngân sách còn lại</span>
      ...
      {showReviewModal && reviewInfluencer && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowReviewModal(false)}>
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 flex items-center justify-between p-6 pb-4 bg-white border-b border-gray-200 rounded-t-2xl">
              <h3 className="text-lg font-bold text-gray-900">Viết đánh giá KOL</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 pt-4">
              ...
              {/* Rating */}
              <div className="mb-4">
                <label className="text-sm font-semibold text-gray-900 mb-2 block">Điểm đánh giá</label>
                <div className="flex items-center gap-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      key={star}
              ...
              {/* Comment */}
              <div className="mb-4">
                <label className="text-sm font-semibold text-gray-900 mb-2 block">Nội dung đánh giá</label>
                <textarea
                  value={reviewData.comment}
                  onChange={(e) => setReviewData({ ...reviewData, comment: e.target.value })}
                  placeholder="Chia sẻ trải nghiệm hợp tác với KOL này..."
                  rows={4}
