  ...
  return (
    <div className="min-h-screen bg-dark-700 pb-20">
      ...
      <div className="container-mobile space-y-6 py-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {prizeDetailsStructure.map((prize, index) => {
              ...
              return (
                <div key={index} className="card bg-dark-600 hover:bg-dark-500 transition-colors">
          ...
          <div className="card bg-gradient-to-r from-success/20 to-success/5 border-success/30">
            <div className="flex items-center gap-2">
        ...
        {/* Exchange Section */}
        <div id="exchange" className="space-y-3">
              ...
              <div
                ...
                className={`card cursor-pointer transition-all ${
                  shoppingPoints >= pkg.points
                    ? 'bg-dark-600 hover:bg-dark-500 border-primary/30 hover:border-primary/50'
                    : 'bg-dark-600/50 border-dark-500 opacity-50 cursor-not-allowed'
                }`}
              >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {topRankers.map((ranker) => (
              <div key={ranker.rank} className="card bg-dark-600">
                <div className="flex items-center gap-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link href="/main/influencer/attendance" className="card bg-dark-600 hover:bg-dark-500 transition-colors text-center py-4">
            ...
            <Link href="/main/influencer/referral" className="card bg-dark-600 hover:bg-dark-500 transition-colors text-center py-4">
            ...
            <Link href="/main/influencer/campaigns" className="card bg-dark-600 hover:bg-dark-500 transition-colors text-center py-4">
            ...
            <Link href="/main/influencer/profile" className="card bg-dark-600 hover:bg-dark-500 transition-colors text-center py-4">
        ...
        {/* CTA */}
        <div className="card bg-gradient-to-r from-red-500/20 via-blue-500/20 to-purple-500/20 border-red-500/30">
          <div className="text-center">
