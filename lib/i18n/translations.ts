...
export const translations: Record<Language, Translations> = {
  vi: {
    homepage: {
      ...
      brands: 'Brands',
      campaigns: 'Campaigns',
      freeSignup: '✅ 무료 가입 & 수수료 0원 Free signup & 0% commission',
      fastMatching: '⚡ 24시간 빠른 매칭 Fast 24h matching',
      securePayment: '💰 안전한 결제 시스템 Secure payment with VND',
      howToStart: '어떻게 시작하시겠어요?',
      howToStartEn: 'How would you like to start?',
      howToStartVi: 'Bạn muốn bắt đầu như thế nào?',
      influencerRole: '인플루언서 / KOL / Influencer',
      ...
      advertiserRole: '광고주 / Brand / Nhà quảng cáo',
      advertiserDesc: '인플루언서를 찾고 브랜드를 홍보하세요',
      ...
      adminLogin: '🔐 관리자 로그인 Admin',
      and: 'và',
      agreeBySigningUp: 'bằng cách đăng ký bạn đồng ý',
    },
    auth: {
      login: {
        title: 'Đăng nhập',
